...
//      Dünner Proxy auf das Backend-Skript "HM_Heizung_LVB" (Ident LVB_HeatAPI unter #<ID>),
...
//      Proxy auf das Backend-Skript "LVB_ShadingAPI" (Ident unter #<ID>). Schreiben laeuft
...
if ($api === 'hierarchy') {
    ...
    $host   = trim((string) ($_GET['host'] ?? '')) ?: '192.168.1.1';
