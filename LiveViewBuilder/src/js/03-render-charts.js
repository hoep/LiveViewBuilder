  ...
  function refreshSun(w){
    ...
    if(w.showNight){
      ...
      sun.setAttribute('cx',cx.toFixed(1));sun.setAttribute('cy',cy.toFixed(1));sun.style.opacity=dayAmt.toFixed(2);      // Sonne + Mond an derselben Position, überblenden per dayAmt
      if(moon){moon.setAttribute('transform','translate('+cx.toFixed(1)+','+cy.toFixed(1)+')');moon.style.opacity=(1-dayAmt).toFixed(2);}
      ...
      sun.setAttribute('cx',x.toFixed(1));sun.setAttribute('cy',y.toFixed(1));sun.style.opacity=((nm>=a&&nm<=b)?1:0.25).toFixed(2);
