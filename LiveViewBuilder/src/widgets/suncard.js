  ...
  defWidget('suncard',{
    ...
    render:function(w){
      var svg=w.showNight
        ? '<svg class="hscsvg" viewBox="0 0 200 128" preserveAspectRatio="none"><path class="hscarc" d="M12 64 Q100 -4 188 64"/><path class="hscarc hscarcn" d="M188 64 Q100 132 12 64"/><line class="hschoriz" x1="0" y1="64" x2="200" y2="64"/><g class="hscmoon" data-role="moon" transform="translate(188,64)"><path d="M4 -5.2 A6 6 0 1 0 4 5.2 A4.6 4.6 0 1 1 4 -5.2 Z"/></g><circle class="hscsun" data-role="sun" cx="12" cy="64" r="7"/></svg>'
        : '<svg class="hscsvg" viewBox="0 0 200 96" preserveAspectRatio="none"><path class="hscarc" d="M12 82 Q100 -6 188 82"/><line class="hschoriz" x1="0" y1="82" x2="200" y2="82"/><circle class="hscsun" data-role="sun" cx="12" cy="82" r="7"/></svg>';
