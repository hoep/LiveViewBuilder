  ...
  defWidget('campro',{
    ...
    render:function(w){return '<div class="hcampro"><img data-role="cam" style="object-fit:'+_camFitCSS(w)+'" src="'+(w.mediaId?('?api=media&id='+w.mediaId):'')+'"><div class="hcpmotion"'+(w.varId?' data-viddot="'+w.varId+'"':'')+'><span style="width:6px;height:6px;border-radius:50%;background:#fff"></span>Bewegung</div><div class="hcpname">'+esc(w.label||'')+'</div></div>';},
