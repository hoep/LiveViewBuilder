...
defWidget('gaugepro',{
  ...
  props:function(w){if(w.type!=='gaugepro')return '';
    ...
    return row('Stil','<select id="pGStyle"><option value="classic"'+((w.gstyle||'classic')==='classic'?' selected':'')+'>Klassisch</option><option value="half"'+(w.gstyle==='half'?' selected':'')+'>Halb-Gauge</option><option value="ring"'+(w.gstyle==='ring'?' selected':'')+'>Donut-Ring</option><option value="halfring"'+(w.gstyle==='halfring'?' selected':'')+'>Halb-Donut</option></select>')+row('Farbe','<select id="pGColor"><option value="accent"'+((w.gcolor||'graded')==='accent'?' selected':'')+'>Akzent</option><option value="graded"'+((w.gcolor||'graded')==='graded'?' selected':'')+'>Abstufung</option><option value="assoc"'+(w.gcolor==='assoc'?' selected':'')+'>Assoziation</option></select>')+((w.gcolor||'graded')==='graded'?(row('Grün bis','<input id="pT1" type="number" value="'+(w.t1!=null?w.t1:'')+'" placeholder="Schwelle">')+row('Gelb bis','<input id="pT2" type="number" value="'+(w.t2!=null?w.t2:'')+'" placeholder="Schwelle">')):'')+row('Teilstriche','<input type="checkbox" id="pGTicks"'+(w.gticks?' checked':'')+'>')+row('Mittelknopf','<input type="checkbox" id="pGKnob"'+(w.gknob?' checked':'')+'>')+row('Winkel °','<input id="pGStart" type="number" style="width:60px" value="'+(w.gstart!=null?w.gstart:'')+'" placeholder="Start"> <input id="pGEnd" type="number" style="width:60px" value="'+(w.gend!=null?w.gend:'')+'" placeholder="Ende">')
