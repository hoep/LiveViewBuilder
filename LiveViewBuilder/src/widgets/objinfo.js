  ...
  defWidget('objinfo',{
    ...
    render:function(w){return '<div style="height:100%;display:flex;flex-direction:column;justify-content:center;padding:clamp(5px,3cqmin,12px) clamp(8px,4.5cqmin,16px);min-width:0"><div style="font-size:var(--wf-lbl);color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis" data-role="oiname">'+escL(w.label||'Objekt')+'</div><div style="font-size:var(--wf-txt);color:var(--text);font-family:var(--fm);white-space:nowrap;overflow:hidden;text-overflow:ellipsis" data-role="oival">–</div></div>';},
