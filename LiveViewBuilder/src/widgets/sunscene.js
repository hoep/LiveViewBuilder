  ...
  (function () {
    ...
    defWidget('sunscene', {
      ...
      props: function (w) {
        ...
        h += row('Breite', '<input id="ssLat" type="number" step="0.0001" value="' + (w.lat != null ? w.lat : '') + '" placeholder="48.2082">');
        h += row('Länge', '<input id="ssLon" type="number" step="0.0001" value="' + (w.lon != null ? w.lon : '') + '" placeholder="16.3738">');
